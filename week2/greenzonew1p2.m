...
GBRMPA_OUTLINE = [142.5 -10.7; 145.0 -10.7; 145.0 -13.0; 147.0 -17.5; ...
    153.0 -21.0; 154.0 -24.5; 152.0 -24.5];
plot(GBRMPA_OUTLINE(:,1), GBRMPA_OUTLINE(:,2), 'r-', 'linewidth', 1.5)

set(gca,'color',[0.94 1 1])
text(145,-21,'Queensland','fontsize',17)
T = text(149.8,-18.74,'GBRMP boundary','fontsize',12);
...
print('-depsc','-r300','-painters','GBRMPA_plot.eps')   % or -dsvg / -dpdf